...
namespace Iql.DotNet.Expressions
{
    internal class ExpressionCSharpStringBuilder : ExpressionVisitor
    {
        ...
        private ExpressionCSharpStringBuilder()
        {
        ...
        public static string ExpressionToString(Expression node)
        {
            ...
            ExpressionCSharpStringBuilder esb = new ExpressionCSharpStringBuilder();
            esb.Visit(node);
            return esb.ToString();
        }
