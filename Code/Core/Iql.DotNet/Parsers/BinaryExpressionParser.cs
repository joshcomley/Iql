...
{
    public class BinaryExpressionParser<T> : ExpressionParserBase<T, BinaryExpression>
    {
        ...
        public override IqlExpression PerformParse(BinaryExpression node, ExpressionParserContext context)
        {
