...
namespace Iql.Entities
{
    public class TypeDetail : ITypeDefinition
    {
        ...
        public TypeDetail(Type type = null, bool nullable = false, Type declaringType = null, string convertedFromType = null, Type elementType = null, bool isCollection = false, IqlType kind = IqlType.Unknown)
        {
            Type = type;
            Nullable = nullable;
