...
namespace Iql.Entities.Relationships
{
        ...
        where T : class
    {
        ...
        public override IqlPropertyEditKind EditKind { get; set; } = IqlPropertyEditKind.Hidden;
        public override IqlPropertyReadKind ReadKind { get; set; } = IqlPropertyReadKind.Hidden;
