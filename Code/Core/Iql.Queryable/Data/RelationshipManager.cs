...
//            SourceTrackingSet = tracking.TrackingSetByType(relationship.Source.Type);
//            TargetTrackingSet = tracking.TrackingSetByType(relationship.Target.Type);
//        }
...
//                tracking.TrackingSetByType(type)
//                    .Track(entity, true);
//            }
//        }
...
//            if (nullable)
//            {
//                DataContext.DataStore.GetTracking().TrackingSetByType(
//                        Relationship.Source.Type)
