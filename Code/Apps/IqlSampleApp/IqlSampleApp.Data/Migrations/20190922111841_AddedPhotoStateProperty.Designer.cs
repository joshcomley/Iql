...
namespace DCodeBrandlessIqlCodeAppsIqlSampleApp.Migrations
{
    ...
    [Migration("20190922111841_AddedPhotoStateProperty")]
    partial class AddedPhotoStateProperty
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IqlSampleApp.Data.Entities.ClientCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("IqlSampleApp.Data.Entities.ClientCategoryPivot", b =>
                {
                    b.Property<int>("ClientId");
                    ...
                    b.ToTable("ClientCategoriesPivot");
                });
            ...
            modelBuilder.Entity("IqlSampleApp.Data.Entities.Person", b =>
                {
                    ...
                    b.Property<int?>("InferredFromUserClientId");

                    b.Property<string>("InferredWhenKeyChanges");
                    ...
                    b.HasIndex("InferredFromUserClientId");
            ...
            modelBuilder.Entity("IqlSampleApp.Data.Entities.Site", b =>
                {
                    ...
                    b.Property<string>("InferredChainFromSelf");

                    b.Property<string>("InferredChainFromUserName");
            ...
            modelBuilder.Entity("IqlSampleApp.Data.Entities.UserSetting", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("IqlSampleApp.Data.Entities.ClientCategoryPivot", b =>
                {
                    b.HasOne("IqlSampleApp.Data.Entities.ClientCategory", "Category")
                        .WithMany("Clients")
            ...
            modelBuilder.Entity("IqlSampleApp.Data.Entities.Person", b =>
                {
                    ...
                    b.HasOne("IqlSampleApp.Data.Entities.Client", "InferredFromUserClient")
                        .WithMany("InferredPeople")
                        .HasForeignKey("InferredFromUserClientId");
