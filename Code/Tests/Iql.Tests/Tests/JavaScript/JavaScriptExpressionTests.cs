...
namespace Iql.Tests.Tests.JavaScript
{
    ...
    public class JavaScriptExpressionTests : TestsBase
    {
        ...
        {
            IqlExpressionExtensions.NormalizeJson = true;
            var query = Db
                .Clients
                .Where(c => c.Name == "a")
...
#if !TypeScript
            var expected = @"function(context) { return context.Where(function(entity) { return ((((entity || {})[""Name""] == null) ? null : ((entity || {})[""Name""] || """").toUpperCase()) == 'A'); }, JSON.parse('{""Left"":{""PropertyName"":""Name"",""Kind"":30,""ReturnType"":1,""Parent"":{""Value"":null,""VariableName"":""c"",""Kind"":28,""ReturnType"":1,""Parent"":null}},""Right"":{""Value"":""a"",""InferredReturnType"":4,""Kind"":26,""ReturnType"":4,""Parent"":null},""Kind"":10,""ReturnType"":1,""Parent"":null}'))
		.Expand(JSON.parse('{""NavigationProperty"":{""PropertyName"":""Type"",""Kind"":30,""ReturnType"":1,""Parent"":{""Value"":null,""VariableName"":""c"",""Kind"":28,""ReturnType"":1,""Parent"":null}},""Query"":{""DataSet"":{""Name"":""ClientTypes"",""Kind"":50,""ReturnType"":2,""Parent"":null},""OrderBys"":null,""IncludeCount"":null,""Skip"":null,""Take"":null,""Expands"":null,""Filter"":null,""WithKey"":null,""Kind"":49,""ReturnType"":3,""Parent"":null},""Count"":false,""Kind"":48,""ReturnType"":2,""Parent"":null}'))
		.Expand(JSON.parse('{""NavigationProperty"":{""PropertyName"":""Sites"",""Kind"":30,""ReturnType"":1,""Parent"":{""Value"":null,""VariableName"":""c"",""Kind"":28,""ReturnType"":1,""Parent"":null}},""Query"":{""DataSet"":{""Name"":""Sites"",""Kind"":50,""ReturnType"":2,""Parent"":null},""OrderBys"":null,""IncludeCount"":null,""Skip"":null,""Take"":null,""Expands"":[{""NavigationProperty"":{""PropertyName"":""CreatedByUser"",""Kind"":30,""ReturnType"":1,""Parent"":{""Value"":null,""VariableName"":""s"",""Kind"":28,""ReturnType"":1,""Parent"":null}},""Query"":{""DataSet"":{""Name"":""Users"",""Kind"":50,""ReturnType"":2,""Parent"":null},""OrderBys"":null,""IncludeCount"":null,""Skip"":null,""Take"":null,""Expands"":null,""Filter"":null,""WithKey"":null,""Kind"":49,""ReturnType"":3,""Parent"":null},""Count"":false,""Kind"":48,""ReturnType"":2,""Parent"":null}],""Filter"":null,""WithKey"":null,""Kind"":49,""ReturnType"":3,""Parent"":null},""Count"":false,""Kind"":48,""ReturnType"":2,""Parent"":null}'))
		.OrderBy(function(entity) { return (entity || {})[""AverageSales""]; }, true); }";
#else
            var expected = @"function(context) { return context.Where(function(entity) { return ((((entity || {})[""Name""] == null) ? null : ((entity || {})[""Name""] || """").toUpperCase()) == 'A'); }, JSON.parse('{""Left"":{""PropertyName"":""Name"",""Kind"":30,""ReturnType"":4,""Parent"":{""Value"":null,""VariableName"":""c"",""Kind"":28,""ReturnType"":1,""Parent"":null}},""Right"":{""Value"":""a"",""InferredReturnType"":4,""Kind"":26,""ReturnType"":4,""Parent"":null},""Kind"":10,""ReturnType"":1,""Parent"":null}'))
		.Expand(JSON.parse('{""NavigationProperty"":{""PropertyName"":""Type"",""Kind"":30,""ReturnType"":1,""Parent"":{""Value"":null,""VariableName"":""c"",""Kind"":28,""ReturnType"":1,""Parent"":null}},""Query"":{""DataSet"":{""Name"":""ClientTypes"",""Kind"":50,""ReturnType"":2,""Parent"":null},""Filter"":null,""WithKey"":null,""Kind"":49,""ReturnType"":3,""Parent"":null},""Count"":false,""Kind"":48,""ReturnType"":2,""Parent"":null}'))
		.Expand(JSON.parse('{""NavigationProperty"":{""PropertyName"":""Sites"",""Kind"":30,""ReturnType"":1,""Parent"":{""Value"":null,""VariableName"":""c"",""Kind"":28,""ReturnType"":1,""Parent"":null}},""Query"":{""DataSet"":{""Name"":""Sites"",""Kind"":50,""ReturnType"":2,""Parent"":null},""Expands"":[{""NavigationProperty"":{""PropertyName"":""CreatedByUser"",""Kind"":30,""ReturnType"":1,""Parent"":{""Value"":null,""VariableName"":""s"",""Kind"":28,""ReturnType"":1,""Parent"":null}},""Query"":{""DataSet"":{""Name"":""Users"",""Kind"":50,""ReturnType"":2,""Parent"":null},""Filter"":null,""WithKey"":null,""Kind"":49,""ReturnType"":3,""Parent"":null},""Count"":false,""Kind"":48,""ReturnType"":2,""Parent"":null}],""Filter"":null,""WithKey"":null,""Kind"":49,""ReturnType"":3,""Parent"":null},""Count"":false,""Kind"":48,""ReturnType"":2,""Parent"":null}'))
		.OrderBy(function(entity) { return (entity || {})[""AverageSales""]; }, true); }";
#endif
            Assert.AreEqual(expected.Clean(), javaScript);
            IqlExpressionExtensions.NormalizeJson = false;
        }
