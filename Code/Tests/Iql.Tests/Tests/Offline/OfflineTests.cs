...
namespace Iql.Tests.Tests.Offline
{
    ...
    public class OfflineTests
    {
        ...
        public async Task OfflineStoreShouldBeUpdatedWithEachPersistedStateChange()
        {
            ...
            Assert.AreEqual(@"[{""Type"":""Client"",""Entities"":[{""Id"":1,""TypeId"":1,""AverageSales"":0,""AverageIncome"":0,""Category"":0,""Discount"":0,""Name"":""Newly added client"",""Guid"":""ff3948f6-2e86-47da-9588-3128b07090a1"",""CreatedDate"":""0001-01-01T00:00:00.0+00:00"",""PersistenceKey"":""dec281fe-96fd-4117-8e4e-2eb575d3b5a2""}]}]",
                state);
            client.Name = "Newly added client2";
            result = await Db.SaveChangesAsync();
            Assert.IsTrue(result.Success);
            state = Db.OfflineInMemoryDataStore.SerializeStateToJson().NormalizeJson();
            Assert.AreEqual(@"[{""Type"":""Client"",""Entities"":[{""Id"":1,""TypeId"":1,""AverageSales"":0,""AverageIncome"":0,""Category"":0,""Discount"":0,""Name"":""Newly added client2"",""Guid"":""ff3948f6-2e86-47da-9588-3128b07090a1"",""CreatedDate"":""0001-01-01T00:00:00.0+00:00"",""PersistenceKey"":""dec281fe-96fd-4117-8e4e-2eb575d3b5a2""}]}]",
                state);
