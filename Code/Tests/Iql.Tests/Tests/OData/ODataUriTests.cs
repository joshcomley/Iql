...
namespace Iql.Tests.Tests.OData
{
    ...
    public class ODataUriTests : TestsBase
    {
        ...
        public async Task TestLengthLiteral()
        {
            ...
            var uri = await query.ResolveODataUriAsync();
            uri = Uri.UnescapeDataString(uri);
            var reducedValue = "463202.03500926";
#if TypeScript
            reducedValue = "463202.03500926046";
#endif
    ...
    , new EvaluateContext(code => Evaluator.Eval(code))
        ...
        {
            //RelationshipMappingExtensions.Dummy = iql =>
            //{
            //    var obj = new CSharpObjectSerializer().Serialize(iql).Initialiser;
            //};
//            var iql = IqlXmlSerializer.DeserializeFromXml(@"<?xml version=""1.0"" encoding=""utf-16""?>
...
//        <VariableName>siteArea</VariableName>
//      </IqlRootReferenceExpression>
//    </Parameters>
