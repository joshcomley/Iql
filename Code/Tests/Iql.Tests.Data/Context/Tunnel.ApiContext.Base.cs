    ...
    public class TunnelDataContextBase: DataContext
    {
        ...
        public override void Configure(EntityConfigurationBuilder builder)
        {
            ...
            builder.EntityType<ReportActionsTaken>().HasKey(p => p.Id, IqlType.Unknown).DefineProperty(p => p.FaultReportId, false, IqlType.Integer).DefineProperty(p => p.CreatedByUserId, true, IqlType.String).ConfigureProperty(p => p.CreatedByUserId, p => {
                ...
                p.ReadOnly = true;
            }).DefinePropertyValidation(p => p.Notes, entity => (((entity.Notes == null ? null : entity.Notes.ToUpper()) != null) || ((entity.Notes == null ? null : entity.Notes.ToUpper()) != ("" == null ? null : "".ToUpper()))), "47ccc5d8-f230-4b25-86de-d1afd67eed27", "Please enter some actions taken notes").DefinePropertyValidation(p => p.Notes, entity => (entity.Notes.Length > 5), "35b9cd02-9abf-45a9-bb18-3aa63ed7c251", "Please enter at least five characters for notes");
            ...
            builder.EntityType<Person>().HasKey(p => p.Id, IqlType.Unknown).DefineProperty(p => p.TypeId, true, IqlType.Integer).ConfigureProperty(p => p.TypeId, p => {
                ...
                p.ReadOnly = true;
            }).DefineCollectionProperty(p => p.Types, p => p.TypesCount).DefineCollectionProperty(p => p.Reports, p => p.ReportsCount).DefineEntityValidation(entity => ((((entity.Title == null ? null : entity.Title.ToUpper()) == null) || ((entity.Title.Trim() == null ? null : entity.Title.Trim().ToUpper()) == ("" == null ? null : "".ToUpper()))) && (((entity.Description == null ? null : entity.Description.ToUpper()) == null) || ((entity.Description.Trim() == null ? null : entity.Description.Trim().ToUpper()) == ("" == null ? null : "".ToUpper())))), "NoTitleOrDescription", "Please enter either a title or a description").DefineEntityValidation(entity => (((entity.Title == null ? null : entity.Title.ToUpper()) == ("Josh" == null ? null : "Josh".ToUpper())) && ((entity.Description == null ? null : entity.Description.ToUpper()) != ("Josh" == null ? null : "Josh".ToUpper()))), "JoshCheck", "If the name is 'Josh' please match it in the description").DefineDisplayFormatter(entity => entity.Title, "Default").DefineDisplayFormatter(entity => (((entity.Title + " (") + entity.Id) + ")"), "Report").DefinePropertyValidation(p => p.Title, entity => (((entity.Title == null ? null : entity.Title.ToUpper()) == null) || ((entity.Title.Trim() == null ? null : entity.Title.Trim().ToUpper()) == ("" == null ? null : "".ToUpper()))), "EmptyTitle", "Please enter a person title").DefinePropertyValidation(p => p.Title, entity => (!((((entity.Title == null ? null : entity.Title.ToUpper()) == null) || ((entity.Title.Trim() == null ? null : entity.Title.Trim().ToUpper()) == ("" == null ? null : "".ToUpper())))) && (entity.Title.Trim().Length > 50)), "TitleMaxLength", "Please enter less than fifty characters").DefinePropertyValidation(p => p.Title, entity => (!((((entity.Title == null ? null : entity.Title.ToUpper()) == null) || ((entity.Title.Trim() == null ? null : entity.Title.Trim().ToUpper()) == ("" == null ? null : "".ToUpper())))) && (entity.Title.Trim().Length < 3)), "TitleMinLength", "Please enter at least three characters for the person's title").DefinePropertyValidation(p => p.Description, entity => (((entity.Description == null ? null : entity.Description.ToUpper()) == null) || ((entity.Description.Trim() == null ? null : entity.Description.Trim().ToUpper()) == ("" == null ? null : "".ToUpper()))), "EmptyDescription", "Please enter a person description").DefineRelationshipFilterRule(p => p.Loading, entity => entity2 => (entity2.Name == entity.Owner.Title), "7e279234-9d63-441c-81af-eedc56623ddb", "").Configure(p => {
                p.Description = "Hello";
            ...
            builder.EntityType<PersonLoading>().HasKey(p => p.Id, IqlType.Unknown).DefineProperty(p => p.Id, false, IqlType.Integer).ConfigureProperty(p => p.Id, p => {
                ...
                p.ReadOnly = true;
            }).DefinePropertyValidation(p => p.Name, entity => (((entity.Name == null ? null : entity.Name.ToUpper()) != null) && ((entity.Name == null ? null : entity.Name.ToUpper()) != ("" == null ? null : "".ToUpper()))), "ad594498-422a-42c1-8867-5ceed666fe17", "Please enter a loading name");
            ...
            builder.EntityType<PersonTypeMap>().HasCompositeKey(p => p.PersonId, p => p.TypeId).DefineProperty(p => p.PersonId, false, IqlType.Integer).DefineProperty(p => p.TypeId, false, IqlType.Integer).DefineProperty(p => p.Notes, false, IqlType.String).DefineProperty(p => p.Description, false, IqlType.String).DefineConvertedProperty(p => p.Guid, "Guid", false, IqlType.String).DefineProperty(p => p.CreatedDate, false, IqlType.Date).ConfigureProperty(p => p.CreatedDate, p => {
                p.ReadOnly = true;
            }).DefineProperty(p => p.Person, false, IqlType.Unknown).DefineProperty(p => p.Type, false, IqlType.Unknown).DefineEntityValidation(entity => ((entity.Description == null ? null : entity.Description.ToUpper()) == null), "IqlEntityValidation", "You have not entered a description").DefinePropertyValidation(p => p.Notes, entity => ((entity.Notes == null ? null : entity.Notes.ToUpper()) == null), "IqlNotesPropertyValidation", "You have not entered any notes");
            ...
            builder.EntityType<PersonReport>().HasKey(p => p.Id, IqlType.Unknown).DefineProperty(p => p.PersonId, false, IqlType.Integer).DefineProperty(p => p.TypeId, false, IqlType.Integer).DefineProperty(p => p.Id, false, IqlType.Integer).ConfigureProperty(p => p.Id, p => {
                ...
                p.ReadOnly = true;
            }).DefinePropertyValidation(p => p.Title, entity => (((entity.Title == null ? null : entity.Title.ToUpper()) == null) || ((entity.Title.Trim() == null ? null : entity.Title.Trim().ToUpper()) == ("" == null ? null : "".ToUpper()))), "a83392af-4778-4e9c-8188-91079e422f99", "Please enter a valid report title").DefinePropertyValidation(p => p.Title, entity => (!((((entity.Title == null ? null : entity.Title.ToUpper()) == null) || ((entity.Title.Trim() == null ? null : entity.Title.Trim().ToUpper()) == ("" == null ? null : "".ToUpper())))) && (entity.Title.Trim().Length > 5)), "ed0047b2-28bf-448a-a8d7-6fb24f21b4c5", "Please enter less than five characters");
