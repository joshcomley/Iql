...
namespace IqlSampleApp.Sets
{
    public class ApplicationUserSet: DbSet<ApplicationUser, string>
    {
        ...
        public virtual ODataMethodRequest IncrementVersion(ApplicationUser bindingParameter, string PropertyName)
        {
            ...
            return ((ODataDataStore) this.DataContext.DataStore).Method(parameters, ODataMethodType.Action, ODataMethodScope.Entity, "IqlSampleApp", "IncrementVersion", typeof(ApplicationUser));
        }
        public virtual ODataDataMethodRequest<string>GetMediaUploadUrl(ApplicationUser bindingParameter, string property)
        {
            ...
            return ((ODataDataStore) this.DataContext.DataStore).MethodWithResponse<string>(parameters, ODataMethodType.Function, ODataMethodScope.Entity, "IqlSampleApp", "GetMediaUploadUrl", typeof(ApplicationUser), typeof(String));
        }
...
namespace IqlSampleApp.Sets
{
    public class ClientSet: DbSet<Client, int>
    {
        ...
        public virtual ODataMethodRequest IncrementVersion(Client bindingParameter, string PropertyName)
        {
            ...
            parameters.Add(new ODataParameter(PropertyName, typeof(string), "PropertyName", false));
            return ((ODataDataStore) this.DataContext.DataStore).Method(parameters, ODataMethodType.Action, ODataMethodScope.Entity, "IqlSampleApp", "IncrementVersion", typeof(Client));
        }
        public virtual ODataDataMethodRequest<string>GetMediaUploadUrl(Client bindingParameter, string property)
        {
            ...
            parameters.Add(new ODataParameter(bindingParameter, typeof(Client), "bindingParameter", true));
            parameters.Add(new ODataParameter(property, typeof(string), "property", false));
            return ((ODataDataStore) this.DataContext.DataStore).MethodWithResponse<string>(parameters, ODataMethodType.Function, ODataMethodScope.Entity, "IqlSampleApp", "GetMediaUploadUrl", typeof(Client), typeof(String));
        }
    }
}
namespace IqlSampleApp.Sets
{
    public class ClientTypeSet: DbSet<ClientType, int>
    {
        ...
        public virtual ODataMethodRequest IncrementVersion(ClientType bindingParameter, string PropertyName)
        {
            ...
            parameters.Add(new ODataParameter(bindingParameter, typeof(ClientType), "bindingParameter", true));
            parameters.Add(new ODataParameter(PropertyName, typeof(string), "PropertyName", false));
            return ((ODataDataStore) this.DataContext.DataStore).Method(parameters, ODataMethodType.Action, ODataMethodScope.Entity, "IqlSampleApp", "IncrementVersion", typeof(ClientType));
        }
        public virtual ODataDataMethodRequest<string>GetMediaUploadUrl(ClientType bindingParameter, string property)
        {
            ...
            parameters.Add(new ODataParameter(bindingParameter, typeof(ClientType), "bindingParameter", true));
            parameters.Add(new ODataParameter(property, typeof(string), "property", false));
            return ((ODataDataStore) this.DataContext.DataStore).MethodWithResponse<string>(parameters, ODataMethodType.Function, ODataMethodScope.Entity, "IqlSampleApp", "GetMediaUploadUrl", typeof(ClientType), typeof(String));
        }
    }
}
namespace IqlSampleApp.Sets
{
    public class DocumentCategorySet: DbSet<DocumentCategory, int>
    {
        ...
        public virtual ODataMethodRequest IncrementVersion(DocumentCategory bindingParameter, string PropertyName)
        {
            ...
            parameters.Add(new ODataParameter(PropertyName, typeof(string), "PropertyName", false));
            return ((ODataDataStore) this.DataContext.DataStore).Method(parameters, ODataMethodType.Action, ODataMethodScope.Entity, "IqlSampleApp", "IncrementVersion", typeof(DocumentCategory));
        }
        public virtual ODataDataMethodRequest<string>GetMediaUploadUrl(DocumentCategory bindingParameter, string property)
        {
            ...
            parameters.Add(new ODataParameter(bindingParameter, typeof(DocumentCategory), "bindingParameter", true));
            parameters.Add(new ODataParameter(property, typeof(string), "property", false));
            return ((ODataDataStore) this.DataContext.DataStore).MethodWithResponse<string>(parameters, ODataMethodType.Function, ODataMethodScope.Entity, "IqlSampleApp", "GetMediaUploadUrl", typeof(DocumentCategory), typeof(String));
        }
    }
}
namespace IqlSampleApp.Sets
{
    public class SiteDocumentSet: DbSet<SiteDocument, int>
    {
        ...
        public virtual ODataMethodRequest IncrementVersion(SiteDocument bindingParameter, string PropertyName)
        {
            ...
            parameters.Add(new ODataParameter(PropertyName, typeof(string), "PropertyName", false));
            return ((ODataDataStore) this.DataContext.DataStore).Method(parameters, ODataMethodType.Action, ODataMethodScope.Entity, "IqlSampleApp", "IncrementVersion", typeof(SiteDocument));
        }
        public virtual ODataDataMethodRequest<string>GetMediaUploadUrl(SiteDocument bindingParameter, string property)
        {
            ...
            parameters.Add(new ODataParameter(bindingParameter, typeof(SiteDocument), "bindingParameter", true));
            parameters.Add(new ODataParameter(property, typeof(string), "property", false));
            return ((ODataDataStore) this.DataContext.DataStore).MethodWithResponse<string>(parameters, ODataMethodType.Function, ODataMethodScope.Entity, "IqlSampleApp", "GetMediaUploadUrl", typeof(SiteDocument), typeof(String));
        }
    }
}
namespace IqlSampleApp.Sets
{
    public class ReportActionsTakenSet: DbSet<ReportActionsTaken, int>
    {
        ...
        public virtual ODataMethodRequest IncrementVersion(ReportActionsTaken bindingParameter, string PropertyName)
        {
            ...
            parameters.Add(new ODataParameter(PropertyName, typeof(string), "PropertyName", false));
            return ((ODataDataStore) this.DataContext.DataStore).Method(parameters, ODataMethodType.Action, ODataMethodScope.Entity, "IqlSampleApp", "IncrementVersion", typeof(ReportActionsTaken));
        }
        public virtual ODataDataMethodRequest<string>GetMediaUploadUrl(ReportActionsTaken bindingParameter, string property)
        {
            ...
            parameters.Add(new ODataParameter(bindingParameter, typeof(ReportActionsTaken), "bindingParameter", true));
            parameters.Add(new ODataParameter(property, typeof(string), "property", false));
            return ((ODataDataStore) this.DataContext.DataStore).MethodWithResponse<string>(parameters, ODataMethodType.Function, ODataMethodScope.Entity, "IqlSampleApp", "GetMediaUploadUrl", typeof(ReportActionsTaken), typeof(String));
        }
    }
}
namespace IqlSampleApp.Sets
{
    public class ReportCategorySet: DbSet<ReportCategory, int>
    {
        ...
        public virtual ODataMethodRequest IncrementVersion(ReportCategory bindingParameter, string PropertyName)
        {
            ...
            parameters.Add(new ODataParameter(PropertyName, typeof(string), "PropertyName", false));
            return ((ODataDataStore) this.DataContext.DataStore).Method(parameters, ODataMethodType.Action, ODataMethodScope.Entity, "IqlSampleApp", "IncrementVersion", typeof(ReportCategory));
        }
        public virtual ODataDataMethodRequest<string>GetMediaUploadUrl(ReportCategory bindingParameter, string property)
        {
            ...
            parameters.Add(new ODataParameter(bindingParameter, typeof(ReportCategory), "bindingParameter", true));
            parameters.Add(new ODataParameter(property, typeof(string), "property", false));
            return ((ODataDataStore) this.DataContext.DataStore).MethodWithResponse<string>(parameters, ODataMethodType.Function, ODataMethodScope.Entity, "IqlSampleApp", "GetMediaUploadUrl", typeof(ReportCategory), typeof(String));
        }
    }
}
namespace IqlSampleApp.Sets
{
    public class ReportDefaultRecommendationSet: DbSet<ReportDefaultRecommendation, int>
    {
        ...
        public virtual ODataMethodRequest IncrementVersion(ReportDefaultRecommendation bindingParameter, string PropertyName)
        {
            ...
            parameters.Add(new ODataParameter(PropertyName, typeof(string), "PropertyName", false));
            return ((ODataDataStore) this.DataContext.DataStore).Method(parameters, ODataMethodType.Action, ODataMethodScope.Entity, "IqlSampleApp", "IncrementVersion", typeof(ReportDefaultRecommendation));
        }
        public virtual ODataDataMethodRequest<string>GetMediaUploadUrl(ReportDefaultRecommendation bindingParameter, string property)
        {
            ...
            parameters.Add(new ODataParameter(bindingParameter, typeof(ReportDefaultRecommendation), "bindingParameter", true));
            parameters.Add(new ODataParameter(property, typeof(string), "property", false));
            return ((ODataDataStore) this.DataContext.DataStore).MethodWithResponse<string>(parameters, ODataMethodType.Function, ODataMethodScope.Entity, "IqlSampleApp", "GetMediaUploadUrl", typeof(ReportDefaultRecommendation), typeof(String));
        }
    }
}
namespace IqlSampleApp.Sets
{
    public class ReportRecommendationSet: DbSet<ReportRecommendation, int>
    {
        ...
        public virtual ODataMethodRequest IncrementVersion(ReportRecommendation bindingParameter, string PropertyName)
        {
            ...
            parameters.Add(new ODataParameter(PropertyName, typeof(string), "PropertyName", false));
            return ((ODataDataStore) this.DataContext.DataStore).Method(parameters, ODataMethodType.Action, ODataMethodScope.Entity, "IqlSampleApp", "IncrementVersion", typeof(ReportRecommendation));
        }
        public virtual ODataDataMethodRequest<string>GetMediaUploadUrl(ReportRecommendation bindingParameter, string property)
        {
            ...
            parameters.Add(new ODataParameter(bindingParameter, typeof(ReportRecommendation), "bindingParameter", true));
            parameters.Add(new ODataParameter(property, typeof(string), "property", false));
            return ((ODataDataStore) this.DataContext.DataStore).MethodWithResponse<string>(parameters, ODataMethodType.Function, ODataMethodScope.Entity, "IqlSampleApp", "GetMediaUploadUrl", typeof(ReportRecommendation), typeof(String));
        }
    }
}
namespace IqlSampleApp.Sets
{
    public class ReportTypeSet: DbSet<ReportType, int>
    {
        ...
        public virtual ODataMethodRequest IncrementVersion(ReportType bindingParameter, string PropertyName)
        {
            ...
            parameters.Add(new ODataParameter(PropertyName, typeof(string), "PropertyName", false));
            return ((ODataDataStore) this.DataContext.DataStore).Method(parameters, ODataMethodType.Action, ODataMethodScope.Entity, "IqlSampleApp", "IncrementVersion", typeof(ReportType));
        }
        public virtual ODataDataMethodRequest<string>GetMediaUploadUrl(ReportType bindingParameter, string property)
        {
            ...
            parameters.Add(new ODataParameter(bindingParameter, typeof(ReportType), "bindingParameter", true));
            parameters.Add(new ODataParameter(property, typeof(string), "property", false));
            return ((ODataDataStore) this.DataContext.DataStore).MethodWithResponse<string>(parameters, ODataMethodType.Function, ODataMethodScope.Entity, "IqlSampleApp", "GetMediaUploadUrl", typeof(ReportType), typeof(String));
        }
    }
}
namespace IqlSampleApp.Sets
{
    public class ProjectSet: DbSet<Project, int>
    {
        ...
        public virtual ODataMethodRequest IncrementVersion(Project bindingParameter, string PropertyName)
        {
            ...
            parameters.Add(new ODataParameter(PropertyName, typeof(string), "PropertyName", false));
            return ((ODataDataStore) this.DataContext.DataStore).Method(parameters, ODataMethodType.Action, ODataMethodScope.Entity, "IqlSampleApp", "IncrementVersion", typeof(Project));
        }
        public virtual ODataDataMethodRequest<string>GetMediaUploadUrl(Project bindingParameter, string property)
        {
            ...
            parameters.Add(new ODataParameter(bindingParameter, typeof(Project), "bindingParameter", true));
            parameters.Add(new ODataParameter(property, typeof(string), "property", false));
            return ((ODataDataStore) this.DataContext.DataStore).MethodWithResponse<string>(parameters, ODataMethodType.Function, ODataMethodScope.Entity, "IqlSampleApp", "GetMediaUploadUrl", typeof(Project), typeof(String));
        }
    }
}
namespace IqlSampleApp.Sets
{
    public class ReportReceiverEmailAddressSet: DbSet<ReportReceiverEmailAddress, int>
    {
        ...
        public virtual ODataMethodRequest IncrementVersion(ReportReceiverEmailAddress bindingParameter, string PropertyName)
        {
            ...
            parameters.Add(new ODataParameter(PropertyName, typeof(string), "PropertyName", false));
            return ((ODataDataStore) this.DataContext.DataStore).Method(parameters, ODataMethodType.Action, ODataMethodScope.Entity, "IqlSampleApp", "IncrementVersion", typeof(ReportReceiverEmailAddress));
        }
        public virtual ODataDataMethodRequest<string>GetMediaUploadUrl(ReportReceiverEmailAddress bindingParameter, string property)
        {
            ...
            parameters.Add(new ODataParameter(bindingParameter, typeof(ReportReceiverEmailAddress), "bindingParameter", true));
            parameters.Add(new ODataParameter(property, typeof(string), "property", false));
            return ((ODataDataStore) this.DataContext.DataStore).MethodWithResponse<string>(parameters, ODataMethodType.Function, ODataMethodScope.Entity, "IqlSampleApp", "GetMediaUploadUrl", typeof(ReportReceiverEmailAddress), typeof(String));
        }
    }
}
namespace IqlSampleApp.Sets
{
    public class RiskAssessmentSet: DbSet<RiskAssessment, int>
    {
        ...
        public virtual ODataMethodRequest IncrementVersion(RiskAssessment bindingParameter, string PropertyName)
        {
            ...
            parameters.Add(new ODataParameter(PropertyName, typeof(string), "PropertyName", false));
            return ((ODataDataStore) this.DataContext.DataStore).Method(parameters, ODataMethodType.Action, ODataMethodScope.Entity, "IqlSampleApp", "IncrementVersion", typeof(RiskAssessment));
        }
        public virtual ODataDataMethodRequest<string>GetMediaUploadUrl(RiskAssessment bindingParameter, string property)
        {
            ...
            parameters.Add(new ODataParameter(bindingParameter, typeof(RiskAssessment), "bindingParameter", true));
            parameters.Add(new ODataParameter(property, typeof(string), "property", false));
            return ((ODataDataStore) this.DataContext.DataStore).MethodWithResponse<string>(parameters, ODataMethodType.Function, ODataMethodScope.Entity, "IqlSampleApp", "GetMediaUploadUrl", typeof(RiskAssessment), typeof(String));
        }
    }
}
namespace IqlSampleApp.Sets
...
namespace IqlSampleApp.Sets
{
    public class RiskAssessmentAnswerSet: DbSet<RiskAssessmentAnswer, int>
    {
        ...
        public virtual ODataMethodRequest IncrementVersion(RiskAssessmentAnswer bindingParameter, string PropertyName)
        {
            ...
            parameters.Add(new ODataParameter(PropertyName, typeof(string), "PropertyName", false));
            return ((ODataDataStore) this.DataContext.DataStore).Method(parameters, ODataMethodType.Action, ODataMethodScope.Entity, "IqlSampleApp", "IncrementVersion", typeof(RiskAssessmentAnswer));
        }
        public virtual ODataDataMethodRequest<string>GetMediaUploadUrl(RiskAssessmentAnswer bindingParameter, string property)
        {
            ...
            parameters.Add(new ODataParameter(bindingParameter, typeof(RiskAssessmentAnswer), "bindingParameter", true));
            parameters.Add(new ODataParameter(property, typeof(string), "property", false));
            return ((ODataDataStore) this.DataContext.DataStore).MethodWithResponse<string>(parameters, ODataMethodType.Function, ODataMethodScope.Entity, "IqlSampleApp", "GetMediaUploadUrl", typeof(RiskAssessmentAnswer), typeof(String));
        }
    }
}
namespace IqlSampleApp.Sets
{
    public class RiskAssessmentQuestionSet: DbSet<RiskAssessmentQuestion, int>
    {
        ...
        public virtual ODataMethodRequest IncrementVersion(RiskAssessmentQuestion bindingParameter, string PropertyName)
        {
            ...
            parameters.Add(new ODataParameter(PropertyName, typeof(string), "PropertyName", false));
            return ((ODataDataStore) this.DataContext.DataStore).Method(parameters, ODataMethodType.Action, ODataMethodScope.Entity, "IqlSampleApp", "IncrementVersion", typeof(RiskAssessmentQuestion));
        }
        public virtual ODataDataMethodRequest<string>GetMediaUploadUrl(RiskAssessmentQuestion bindingParameter, string property)
        {
            ...
            parameters.Add(new ODataParameter(bindingParameter, typeof(RiskAssessmentQuestion), "bindingParameter", true));
            parameters.Add(new ODataParameter(property, typeof(string), "property", false));
            return ((ODataDataStore) this.DataContext.DataStore).MethodWithResponse<string>(parameters, ODataMethodType.Function, ODataMethodScope.Entity, "IqlSampleApp", "GetMediaUploadUrl", typeof(RiskAssessmentQuestion), typeof(String));
        }
    }
}
namespace IqlSampleApp.Sets
{
    public class PersonSet: DbSet<Person, int>
    {
        ...
        public virtual ODataMethodRequest IncrementVersion(Person bindingParameter, string PropertyName)
        {
            ...
            parameters.Add(new ODataParameter(PropertyName, typeof(string), "PropertyName", false));
            return ((ODataDataStore) this.DataContext.DataStore).Method(parameters, ODataMethodType.Action, ODataMethodScope.Entity, "IqlSampleApp", "IncrementVersion", typeof(Person));
        }
        public virtual ODataDataMethodRequest<string>GetMediaUploadUrl(Person bindingParameter, string property)
        {
            ...
            parameters.Add(new ODataParameter(bindingParameter, typeof(Person), "bindingParameter", true));
            parameters.Add(new ODataParameter(property, typeof(string), "property", false));
            return ((ODataDataStore) this.DataContext.DataStore).MethodWithResponse<string>(parameters, ODataMethodType.Function, ODataMethodScope.Entity, "IqlSampleApp", "GetMediaUploadUrl", typeof(Person), typeof(String));
        }
    }
}
namespace IqlSampleApp.Sets
{
    public class PersonInspectionSet: DbSet<PersonInspection, int>
    {
        ...
        public virtual ODataMethodRequest IncrementVersion(PersonInspection bindingParameter, string PropertyName)
        {
            ...
            parameters.Add(new ODataParameter(PropertyName, typeof(string), "PropertyName", false));
            return ((ODataDataStore) this.DataContext.DataStore).Method(parameters, ODataMethodType.Action, ODataMethodScope.Entity, "IqlSampleApp", "IncrementVersion", typeof(PersonInspection));
        }
        public virtual ODataDataMethodRequest<string>GetMediaUploadUrl(PersonInspection bindingParameter, string property)
        {
            ...
            parameters.Add(new ODataParameter(bindingParameter, typeof(PersonInspection), "bindingParameter", true));
            parameters.Add(new ODataParameter(property, typeof(string), "property", false));
            return ((ODataDataStore) this.DataContext.DataStore).MethodWithResponse<string>(parameters, ODataMethodType.Function, ODataMethodScope.Entity, "IqlSampleApp", "GetMediaUploadUrl", typeof(PersonInspection), typeof(String));
        }
    }
}
namespace IqlSampleApp.Sets
{
    public class PersonLoadingSet: DbSet<PersonLoading, int>
    {
        ...
        public virtual ODataMethodRequest IncrementVersion(PersonLoading bindingParameter, string PropertyName)
        {
            ...
            parameters.Add(new ODataParameter(PropertyName, typeof(string), "PropertyName", false));
            return ((ODataDataStore) this.DataContext.DataStore).Method(parameters, ODataMethodType.Action, ODataMethodScope.Entity, "IqlSampleApp", "IncrementVersion", typeof(PersonLoading));
        }
        public virtual ODataDataMethodRequest<string>GetMediaUploadUrl(PersonLoading bindingParameter, string property)
        {
            ...
            parameters.Add(new ODataParameter(bindingParameter, typeof(PersonLoading), "bindingParameter", true));
            parameters.Add(new ODataParameter(property, typeof(string), "property", false));
            return ((ODataDataStore) this.DataContext.DataStore).MethodWithResponse<string>(parameters, ODataMethodType.Function, ODataMethodScope.Entity, "IqlSampleApp", "GetMediaUploadUrl", typeof(PersonLoading), typeof(String));
        }
    }
}
namespace IqlSampleApp.Sets
{
    public class PersonTypeSet: DbSet<PersonType, int>
    {
        ...
        public virtual ODataMethodRequest IncrementVersion(PersonType bindingParameter, string PropertyName)
        {
            ...
            parameters.Add(new ODataParameter(PropertyName, typeof(string), "PropertyName", false));
            return ((ODataDataStore) this.DataContext.DataStore).Method(parameters, ODataMethodType.Action, ODataMethodScope.Entity, "IqlSampleApp", "IncrementVersion", typeof(PersonType));
        }
        public virtual ODataDataMethodRequest<string>GetMediaUploadUrl(PersonType bindingParameter, string property)
        {
            ...
            parameters.Add(new ODataParameter(bindingParameter, typeof(PersonType), "bindingParameter", true));
            parameters.Add(new ODataParameter(property, typeof(string), "property", false));
            return ((ODataDataStore) this.DataContext.DataStore).MethodWithResponse<string>(parameters, ODataMethodType.Function, ODataMethodScope.Entity, "IqlSampleApp", "GetMediaUploadUrl", typeof(PersonType), typeof(String));
        }
    }
}
namespace IqlSampleApp.Sets
{
    public class PersonTypeMapSet: DbSet<PersonTypeMap, CompositeKey>
    {
        ...
        public virtual ODataMethodRequest IncrementVersion(PersonTypeMap bindingParameter, string PropertyName)
        {
            ...
            parameters.Add(new ODataParameter(PropertyName, typeof(string), "PropertyName", false));
            return ((ODataDataStore) this.DataContext.DataStore).Method(parameters, ODataMethodType.Action, ODataMethodScope.Entity, "IqlSampleApp", "IncrementVersion", typeof(PersonTypeMap));
        }
        public virtual ODataDataMethodRequest<string>GetMediaUploadUrl(PersonTypeMap bindingParameter, string property)
        {
            ...
            parameters.Add(new ODataParameter(bindingParameter, typeof(PersonTypeMap), "bindingParameter", true));
            parameters.Add(new ODataParameter(property, typeof(string), "property", false));
            return ((ODataDataStore) this.DataContext.DataStore).MethodWithResponse<string>(parameters, ODataMethodType.Function, ODataMethodScope.Entity, "IqlSampleApp", "GetMediaUploadUrl", typeof(PersonTypeMap), typeof(String));
        }
    }
}
namespace IqlSampleApp.Sets
{
    public class PersonReportSet: DbSet<PersonReport, int>
    {
        ...
        public virtual ODataMethodRequest IncrementVersion(PersonReport bindingParameter, string PropertyName)
        {
            ...
            parameters.Add(new ODataParameter(PropertyName, typeof(string), "PropertyName", false));
            return ((ODataDataStore) this.DataContext.DataStore).Method(parameters, ODataMethodType.Action, ODataMethodScope.Entity, "IqlSampleApp", "IncrementVersion", typeof(PersonReport));
        }
        public virtual ODataDataMethodRequest<string>GetMediaUploadUrl(PersonReport bindingParameter, string property)
        {
            ...
            parameters.Add(new ODataParameter(bindingParameter, typeof(PersonReport), "bindingParameter", true));
            parameters.Add(new ODataParameter(property, typeof(string), "property", false));
            return ((ODataDataStore) this.DataContext.DataStore).MethodWithResponse<string>(parameters, ODataMethodType.Function, ODataMethodScope.Entity, "IqlSampleApp", "GetMediaUploadUrl", typeof(PersonReport), typeof(String));
        }
    }
}
namespace IqlSampleApp.Sets
{
    public class SiteSet: DbSet<Site, int>
    {
        ...
        public virtual ODataMethodRequest IncrementVersion(Site bindingParameter, string PropertyName)
        {
            ...
            parameters.Add(new ODataParameter(PropertyName, typeof(string), "PropertyName", false));
            return ((ODataDataStore) this.DataContext.DataStore).Method(parameters, ODataMethodType.Action, ODataMethodScope.Entity, "IqlSampleApp", "IncrementVersion", typeof(Site));
        }
        public virtual ODataDataMethodRequest<string>GetMediaUploadUrl(Site bindingParameter, string property)
        {
            ...
            parameters.Add(new ODataParameter(bindingParameter, typeof(Site), "bindingParameter", true));
            parameters.Add(new ODataParameter(property, typeof(string), "property", false));
            return ((ODataDataStore) this.DataContext.DataStore).MethodWithResponse<string>(parameters, ODataMethodType.Function, ODataMethodScope.Entity, "IqlSampleApp", "GetMediaUploadUrl", typeof(Site), typeof(String));
        }
    }
}
namespace IqlSampleApp.Sets
...
namespace IqlSampleApp.Sets
{
    public class SiteInspectionSet: DbSet<SiteInspection, int>
    {
        ...
        public virtual ODataMethodRequest IncrementVersion(SiteInspection bindingParameter, string PropertyName)
        {
            ...
            parameters.Add(new ODataParameter(PropertyName, typeof(string), "PropertyName", false));
            return ((ODataDataStore) this.DataContext.DataStore).Method(parameters, ODataMethodType.Action, ODataMethodScope.Entity, "IqlSampleApp", "IncrementVersion", typeof(SiteInspection));
        }
        public virtual ODataDataMethodRequest<string>GetMediaUploadUrl(SiteInspection bindingParameter, string property)
        {
            ...
            parameters.Add(new ODataParameter(bindingParameter, typeof(SiteInspection), "bindingParameter", true));
            parameters.Add(new ODataParameter(property, typeof(string), "property", false));
            return ((ODataDataStore) this.DataContext.DataStore).MethodWithResponse<string>(parameters, ODataMethodType.Function, ODataMethodScope.Entity, "IqlSampleApp", "GetMediaUploadUrl", typeof(SiteInspection), typeof(String));
        }
    }
}
namespace IqlSampleApp.Sets
...
namespace IqlSampleApp.Sets
{
    public class UserSiteSet: DbSet<UserSite, CompositeKey>
    {
        ...
        public virtual ODataMethodRequest IncrementVersion(UserSite bindingParameter, string PropertyName)
        {
            ...
            parameters.Add(new ODataParameter(PropertyName, typeof(string), "PropertyName", false));
            return ((ODataDataStore) this.DataContext.DataStore).Method(parameters, ODataMethodType.Action, ODataMethodScope.Entity, "IqlSampleApp", "IncrementVersion", typeof(UserSite));
        }
        public virtual ODataDataMethodRequest<string>GetMediaUploadUrl(UserSite bindingParameter, string property)
        {
            ...
            parameters.Add(new ODataParameter(bindingParameter, typeof(UserSite), "bindingParameter", true));
            parameters.Add(new ODataParameter(property, typeof(string), "property", false));
            return ((ODataDataStore) this.DataContext.DataStore).MethodWithResponse<string>(parameters, ODataMethodType.Function, ODataMethodScope.Entity, "IqlSampleApp", "GetMediaUploadUrl", typeof(UserSite), typeof(String));
        }
    }
}