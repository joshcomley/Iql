...
using Iql.Entities;
namespace IqlSampleApp.ApiContext.Base.Properties
{
    public class IqlSampleAppPropertyService: PropertyService
    {
        public IqlSampleAppPropertyService(IEntityConfigurationBuilder builder) : base(builder)
        {}
